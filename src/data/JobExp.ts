...
export const exp = [
  new JobExperience(
    ...
    "Present",
    [
      "At Sesimi, I contribute to a multi-tenant payments platform processing over 5,000 daily transactions for enterprise brands across North America. I develop production features using React (TypeScript), Ruby on Rails, MongoDB, and PostgreSQL, working with large-scale datasets and high-throughput workflows. I partner with Customer Service and stakeholders to translate live feedback into product improvements, operational reporting, and reliable production support.",
    ],
    "https://sesimi.com",
