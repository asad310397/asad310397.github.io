  ...
  function toggleDarkTheme() {
    ...
    if (isDarkTheme) {
      ...
      home1bgimg.style.backgroundImage =
        "url('assets/img/bg/page-bg-dark-1.png')";
    } else {
      darktoggle.src = "assets/img/icon/mon-icon.png";
      home1bgimg.style.backgroundImage = "url('assets/img/bg/page-bg-1.png')";
      home2bgimg.style.backgroundImage = "url('assets/img/bg/page-bg-1.png')";
    }
  }
